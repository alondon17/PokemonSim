...
public class Move {
    ...
    public Move(int id, int type, String name, int pp, int power, int PhysSpecStatCode, int accuracy, int priority, byte target, MoveFunction function, int effectChance) {
        this.id = id;
        this.type = type;
        this.name = name;
        this.pp = pp;
